      ...
      <div className="mx-auto flex h-14 max-w-5xl items-center justify-between px-6">
        ...
        <div className="flex items-center gap-6 text-sm">
          <a
            ...
            className="flex items-center gap-1.5 rounded-md border border-[var(--border)] px-3 py-1.5 font-mono text-xs text-[var(--text-secondary)] transition hover:border-[var(--accent-amber)] hover:text-[var(--accent-amber)]"
          >
